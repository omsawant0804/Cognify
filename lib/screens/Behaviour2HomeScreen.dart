...
class BehaviourHomeScreenApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Behaviour2HomeScreen(),
    );
  }
}

class Behaviour2HomeScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
      ...
      body: ListView(
        ...
        children: [
          _buildGameTypeSection([
            ...
            //SBHomeScreen()
           // _buildGameCard(context, 'Communication behaviour learning ', SBHomeScreen(), '😊'),
            //_buildGameCard(context, 'Communication behaviour Challenge ', ComBehvHome(), '😊'),
